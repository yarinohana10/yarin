  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 right-4">
        <Link to="/">
          <Button variant="outline" className="bg-white/90 hover:bg-gray-100 text-xs md:text-sm">
            <Home className="h-3 w-3 md:h-4 md:w-4 ml-2" />
            חזרה לעמוד הבית
          </Button>
        </Link>
      </div>
      ...
      <Card className="max-w-md w-full bg-white/95 shadow-xl">
        <CardContent className="p-6 md:p-8 text-center">
          {attending === 'attending' ? (
            <>
              <h2 className="text-xl md:text-2xl font-bold text-[#F0B6BC] mb-4">
                תודה על אישור ההגעה!
              </h2>
              <p className="text-base md:text-lg mb-6">
                נתראה בשמחה
                <br />
                <span className="text-lg md:text-xl font-semibold">ORAN & YARIN</span>
              </p>
            ...
            <>
              <h2 className="text-xl md:text-2xl font-bold text-[#f0b95a] mb-4">
                תודה על העדכון!
              </h2>
              <p className="text-base md:text-lg mb-6">
                נשמח לראותך
